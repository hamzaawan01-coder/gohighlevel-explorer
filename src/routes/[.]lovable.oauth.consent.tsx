...
function Consent() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-6 bg-background text-foreground">
      <div className="w-full max-w-md border border-border bg-card rounded-lg p-6">
        <h1 className="text-lg font-semibold mb-2">Connect {clientName} to your account</h1>
        <p className="text-sm text-muted-foreground mb-6">
          This lets {clientName} read and update your CRM data as you.
        </p>
        {error && (
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="flex-1 border border-border rounded-md py-2 text-sm font-medium disabled:opacity-50"
          >
            Deny
          </button>
        </div>
