              ...
              {pageRows.length === 0 ? (
                ...
                pageRows.map((row) => (
                  <tr
                    ...
                    className={`border-b border-border/70 last:border-0 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring ${
